...
//   Fetch the results in an associative array
  ...
  print '<tr>';
  print '<th scope="col">FINE ID</th>';
  print  '<th scope="col">MEMBER ID</th>';
  print  '<th scope="col">ISBN</th>';
  print  '<th scope="col">FINE DESC</th>';
  print  '<th scope="col">FINE AMOUNT</th>';
  print  '<th scope="col">DAMAGE DESCRIPTION</th>';
  print  '<th scope="col">OVERDUE DESCRIPTION</th>';
  print '</tr>';    
  print '</thead>';
